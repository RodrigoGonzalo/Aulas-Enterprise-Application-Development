...
public class ExibindoImagem {
	public static void main(String[] args) throws IOException {
		...
		Path path = FileSystems.getDefault().getPath("C:\\Users\\logonrmlocal\\git\\Aulas-Enterprise-Application-Development\\Aulas - Eclipse Workspace\\loja-veiculos\\arquivos-extras\\ix35.jpg");
